  ...
  <div class="row justify-content-center">
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          {!! Form::open(array('route' => ['electricianComplaintUpdate' , $complaint->id],'method'=>'PUT')) !!}
            <div class="row">
              <h5 class="styled-heading">Basic Information</h5>
              <div class="col-lg-2">
                <div class="mb-2">
                  <label for="control_number" class="form-label mb-1">Complaint No. *</label>
                    <input type="number" class="form-control" id="control_number" name="control_number" value="{{$complaint->control_number}}" required>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="mb-2">
