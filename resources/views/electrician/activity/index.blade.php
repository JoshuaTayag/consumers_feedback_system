          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                  <div class="col-lg-6">
                      <span class="mb-0 align-middle fs-3">Electricians Activities/Meeting</span>
                  </div>
                  <div class="col-lg-6 text-end">
                    <a class="btn btn-secondary btn-md text-end" href="{{ route('electricianActivityCreate') }}">
            ...
            <div class="card-body">
              ...
              <table class="table table-striped table-bordered border-primary">
                ...
                <tbody id="show_data">
                  @include('electrician.activity.search')
                </tbody>
               </table>
