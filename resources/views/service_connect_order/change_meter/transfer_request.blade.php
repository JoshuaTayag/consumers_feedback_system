<div class="modal fade" id="transferRequestModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
      ...
      <div class="modal-body">
        {!! Form::open(array('route' => 'cmTransferOfDispatching','method'=>'POST', 'id' => 'myForm')) !!}
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <label for="crew_dispatched_to">To:</label>
