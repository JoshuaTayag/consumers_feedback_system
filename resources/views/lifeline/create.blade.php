            ...
            <div class="tab-pane fade show active" id="4ps" role="tabpanel" aria-labelledby="4ps-tab">
              {!! Form::open(array('route' => 'lifeline.store','method'=>'POST')) !!}
                  ...
                  <div class="col-lg-3">
                    <div class="mb-2">
                      <label for="house_no_zone_purok_sitio" class="form-label mb-1">House No./Zone/Purok/Sitio</label>
                        <input type="text" class="form-control" id="house_no_zone_purok_sitio" name="house_no_zone_purok_sitio">
                    </div>
                  </div>
                  <div class="col-lg-2">
                    <div class="mb-2">
                ...
                <div class="row">
                    ...
                    <div class="mb-2">
                      ...
                      <select id="marital_status" class="form-control" name="marital_status" required>
                        ...
                        @foreach (Config::get('constants.civil_status') as $status)          
                          <option value="{{ $status['id'] }}" id="">{{ $status['status_name'] }}</option>
                        @endforeach 
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="mb-2">
                      <label for="electric_service_details" class="form-label mb-1">Electric Service Details *</label>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="mb-2">
                      ...
                      <input type="text" class="form-control" id="representative_id_no" name="representative_id_no">
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="mb-2">
                      <label for="representative_fullname" class="form-label mb-1">Rep Full Name (IF FILED THROUGH A REPRESENTATIVE)</label>
                      <input type="text" class="form-control" id="representative_fullname" name="representative_fullname">
                    </div>
                  </div>
                </div>
                <div class="row">
            ...
            <div class="tab-pane fade" id="non4ps" role="tabpanel" aria-labelledby="non4ps-tab">
              ...
              <div class="col-lg-3">
                <div class="mb-2">
                  ...
                  <input type="text" class="form-control" id="sdwo_certification" name="sdwo_certification">
                </div>
              </div>
              <div class="col-lg-3">
                <div class="mb-2">
                  <label for="validity_period" class="form-label mb-1">Validity Period</label>
                  <input type="date" class="form-control" id="validity_period" name="validity_period">
                </div>
              </div>
            </div>
          </div>
