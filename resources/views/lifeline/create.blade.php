                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="mb-2">
                      ...
                      <input type="text" class="form-control" id="sdwo_certification" name="sdwo_certification" required>
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="mb-2">
                      <label for="validity_period" class="form-label mb-1">Validity Period *</label>
                      <input type="date" class="form-control" id="validity_period" name="validity_period" required>
                    </div>
                  </div>
                  {{-- <div class="col-lg-2">
                    <div class="mb-2">
