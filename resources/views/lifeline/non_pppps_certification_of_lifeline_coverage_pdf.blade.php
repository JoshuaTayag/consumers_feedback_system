...
    <h2 class="heading">LEYTE V ELECTRIC COOPERATIVE, INC.</h2>
  ...
  <div class="text-align">
    <p>
      ...
      is found to be a qualified marginalized end-user under Rule 6. Section 1(b) of the Implementing Rules and Regulations of Republic Act No. 11552. 
    ...
    <p> 
      In case of transfer of residence, the above qualified marginalized end­user shall inform Leyte V Electric Cooperative, Inc. (LEYECO V) 
      for issuance of Certificate of Un-Tagging in case it will be served by a different Distribution Utility. 
    </p>

    <p>
      The validity of the grant of Lifeline Rate shall be from 
      <span class="text-underline">{{ date('F d, Y', strtotime($data->validity_period_from)) }}</span> to <span class="text-underline">{{ date('F d, Y', strtotime($data->validity_period_to)) }}</span>, 
      without prejudice to the responsibility of the Leyte V Electric Cooperative, Inc. (LEYECO V) to conduct, at any time, a validation to ensure 
