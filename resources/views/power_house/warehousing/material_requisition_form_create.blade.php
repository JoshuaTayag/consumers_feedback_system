        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open([
                            'route' => 'material-requisition-form.store',
                            'method' => 'POST',
                                    ...
                                    <div class="input-group">
                                        <select id="structure" class="form-control" name="structure">
                                            ...
                                            @foreach ($structures as $structure)
                                                <option value="{{ $structure['id'] }}" id="">
                                                    {{ $structure['structure_code'] }}</option>
                                            @endforeach
                                        </select>
                                        <span class="input-group-addon"><a href="#" id="get_items" name="get_items"
                                                class="btn btn-success"><i class="fa fa-plus"></i></a></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
    ...
    @endforeach
                            ...
                            <div class="col-lg-8">
                                <div class="mb-2">
                                    ...
                                    <select class="js-example-basic-multiple form-control" id="item"
                                        name="item"></select>
                                </div>
                            </div>
                            <div class="col-lg-1 align-bottom">
                                <div class="mb-2">
                                    ...
                                    <a href="#" id="add_item" name="add_item" class="btn btn-success"><i
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="substation" class="form-control" name="substation">
                                        ...
                                        @foreach (Config::get('constants.substations') as $substation)
                                            <option value="{{ $substation['id'] }}" id=""
                                                {{ old('substation') ? 'selected' : '' }}>{{ $substation['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-2">
                                    <table class="table table-bordered data-table">
                                        <tr>
                                            ...
                                            <th>Description</th>
                                            <th>Unit</th>
                                            <th width="120px">Unit Cost</th>
                                            <th>Quantity</th>
                                            <th width="130px">Existing Cost</th>
        ...
        $(document).ready(function() {
            ...
            $('#add_item').click(function() {
                ...
                if (item_id != null) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Please fill up the Item field!',
                    });
                }
