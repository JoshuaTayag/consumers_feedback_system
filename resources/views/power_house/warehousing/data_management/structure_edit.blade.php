      ...
      <div class="card">
        <div class="card-header">
          <div class="row align-items-center">
              <div class="col-lg-6">
                  <span class="mb-0 align-middle fs-3">Edit Structure</span>
              </div>
        ...
        <div class="card-body">
          {!! Form::open(array('route' => ['structure.update', $structure->id], 'method'=>'PUT')) !!}
            <div class="row">
              <div class="col-lg-2">
                <div class="mb-2">
                  <label for="structure_code" class="form-label mb-1">Structure Code *</label>
                    <input type="text" class="form-control" id="structure_code" name="structure_code" value="{{$structure->structure_code}}" required>
                </div>
              </div>
              <div class="col-lg-2">
                <div class="mb-2">
                  ...
                  <select id="status" class="form-control" name="status" required>
                    <option value="1" @selected($structure->status == '1' ) >Active</option>
                    <option value="0" @selected($structure->status == '0' )>In Active</option>
                </select>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="mb-2">
                  ...
                  <textarea class="form-control" name="remarks" id="exampleFormControlTextarea1">{{$structure->remarks}}</textarea>
                </div>
              </div>
