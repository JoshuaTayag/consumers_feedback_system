      ...
      <div class="card">
        ...
        <div class="card-body">
          {!! Form::open(array('route' => ['material-requisition-form.update', $mrf->id],'method'=>'PUT')) !!}
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-2">
                  ...
                  <input type="text" class="form-control" id="project_name" name="project_name" value="{{$mrf->project_name}}" required @disabled($mrf->status != 0)>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="mb-2">
              ...
              <div class="col-lg-3">
                <div class="mb-3">
                  <label for="requested_by" class="form-label mb-1">Requested By</label>
                    <select id="requested_by" class="form-control" name="requested_by" required @disabled($mrf->status != 0)>
              ...
              <div class="col-lg-1 align-bottom">
                <div class="mb-2">
                  ...
                  @if($mrf->status == 0)
                    <a href="#" id="add_item" name="add_item" class="btn btn-success" @disabled($mrf->status != 0)><i class="fa fa-plus"></i></a>
                  @endif
                </div>
              </div>
              <div class="col-lg-3">
                <div class="mb-3">
                  <label for="structure" class="form-label mb-1">
                    ...
                    <select id="approved_by" class="form-control" name="approved_by" required @disabled($mrf->status != 0)>
                      @foreach ($users as $user)          
            ...
            <div class="row">
              <div class="col-lg-3">
                <div class="mb-3">
                  ...
                  <select id="district" class="form-control" name="district" required @disabled($mrf->status != 0)>
                      <option value="">Choose...</option>
              ...
              <div class="col-lg-3">
                <div class="mb-3">
                  ...
                  <select id="municipality" class="form-control" name="municipality" @disabled($mrf->status != 0)>
              ...
              <div class="col-lg-3">
                <div class="mb-3">
                  ...
                  <select id="barangay" class="form-control" name="barangay" @disabled($mrf->status != 0)>
              ...
              <div class="col-lg-3">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="sitio" name="sitio" value="{{$mrf->sitio }}" required @disabled($mrf->status != 0)>
                </div>
              </div>
              <div class="col-lg-12">
                <div class="mb-2">
              ...
              <div class="col-lg-12">
                <div class="mb-2">
                  ...
                  <textarea class="form-control" name="remarks" id="exampleFormControlTextarea1" @disabled($mrf->status != 0)>{{$mrf->remarks }}</textarea>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <input type="submit" class="btn btn-primary btn-sm fa fa-trash" value="Save" @disabled($mrf->status != 0)>
              {!! Form::close() !!} 
