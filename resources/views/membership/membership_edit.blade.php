    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action = "{{ route('membership.update', $member->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    {{-- {{ $member->{'OR No Issued'} }} --}}
                                    <input type="text" class="form-control" id="or_no" value="{{ $member->{'OR No'} }}" name="or_no">
                                </div>
                                <div class="mb-2">
                                    <label for="first_name" class="form-label mb-1">First Name *</label>
                                    <input type="text" class="form-control" id="first_name" value="{{ $member->{'First Name'} }}" name="first_name">
                                </div>
                                <div class="mb-2">
                                    <label for="middle_name" class="form-label mb-1">Middle Name *</label>
                                    <input type="text" class="form-control" id="middle_name" value="{{ $member->{'Middle Name'} }}" name="middle_name">
                                </div>
                                <div class="mb-2">
                                    <label for="last_name" class="form-label mb-1">Last Name *</label>
                                    <input type="text" class="form-control" id="last_name" value="{{ $member->{'Last Name'} }}" name="last_name">
                                </div>
                                <div class="mb-2">
                                    <div class="row my-2">
                                        <div class="col-lg-10">
                                            <label for="spouse" class="form-label mb-1">Spouse (If Married)</label>
                                            <input type="text" class="form-control" id="spouse" value="{{ $member->{'Joint Name'} }}" name="spouse">
                                        </div>
                                        <div class="col-lg-2">
                                            <label for="joint" class="form-label mb-1">Joint</label><br>
                                            <input type="checkbox" class="form-check-input" id="joint" {{  ($member->Joint == 1 ? ' checked' : '') }} name="joint">
                                        </div>
                                        {{-- <div class="col-lg-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="date" class="form-control" id="date_of_birth" value="{{ date('Y-m-d', strtotime( $member->DateBirth )) }}" name="date_of_birth">
                                </div>
                                <div class="mb-2">
                                    <label for="contact_no" class="form-label mb-1">Contact No. </label>
                                    <input type="number" class="form-control" id="contact_no" value="{{ $member->Celphone }}" name="contact_no">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    <input type="date" class="form-control" id="or_no_issued" value="{{ date('Y-m-d', strtotime($member->{'OR No Issued'})) }}" name="or_no_issued">
                                </div>
                                <div class="mb-2">
                                    ...
                                    <select id="district" class="form-control" name="district" required>
                                        ...
                                        @foreach ($districts as $district)                        
                                            <option value="{{ $district->district_name }}" id="{{ $district->id }}" @selected( $district->district_name == $member->District)>{{$district->district_name}}</option>
                                        @endforeach 
                                    </select>
                                </div>
                                <div class="mb-2">
                                    ...
                                    <select id="municipality" class="form-control" name="municipality">
                                        <option value="{{ $member->Municipality }}" >{{$member->Municipality }}</option>
                                    </select>
                                </div>
                                <div class="mb-2">
                                    <label for="barangay" class="form-label mb-1">Barangay</label>
                                    <select id="barangay" class="form-control" name="barangay">
                                        <option value="{{ $member->Brgy }}" >{{$member->Brgy }}</option>
                                    </select>
                                </div>
                                <div class="mb-2">
                                    <label for="sitio" class="form-label mb-1">Sitio </label>
                                    <input type="text" class="form-control" id="sitio" value="{{ $member->Sitio }}" name="sitio">
                                </div>
                                <div class="mb-2">
                                    ...
                                    <select id="membership_status" class="form-control" name="membership_status" required>
                                      ...
                                      @foreach (Config::get('constants.membership_status') as $status)          
                                        <option value="{{ $status['status_name'] }}" id="" @selected(trim($member->Status) == $status['status_name'] )>{{ $status['status_name'] }}</option>
                                      @endforeach 
                                    </select>
                                </div>
                                <div class="mb-2">
                                  ...
                                  <select id="membership_type" class="form-control" name="membership_type" required>
                                    ...
                                    @foreach (Config::get('constants.membership_type') as $type)          
                                      <option value="{{ $type['name'] }}" id="" @selected(trim($member->MemType) == $type['name'] )>{{ $type['name'] }}</option>
                                    @endforeach 
                                  </select>
                              </div>
                            </div>  
                            <div class="col-lg-12">
                              ...
                              <textarea class="form-control" name="remarks" id="exampleFormControlTextarea1">{{ $member->Remarks }}</textarea>
                            </div>
